...
function ModifyReviewModal({ selectedReview, onCancel, modifyReview }) {
  ...
  useEffect(() => {
    setReview({ grade: selectedReview.grade, content: selectedReview.content });
  }, [selectedReview]);
  ...
  return (
    ...
    >
      <div className="absolute bg-white shadow opacity-100 md:w-1/4 rounded mt-10 mb-10 px-6 md:min-w-[750px] text-stone-700">
